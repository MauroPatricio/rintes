...
export default function RequestDelivermanHistoryByUserScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const { data } = await axios.get(`/api/requestdeliver/userview?user=${userInfo._id}&page=${page}`, {
  ...
  return (
    <div>
      <Helmet>
        <title>Histórico de solicitações de entregadores</title>
      </Helmet>
      <h1>Histórico de solicitações de entregadores</h1>
